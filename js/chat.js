$(document).ready(function(e){
    ...
    const CLIENT_ID = 'MN0KRjnoJ5F6BTFB';
    ...
    if  ( localStorage.getItem("username") ) {
        ...
        $('.create-username-container').hide();

        createChat(username, usercolor);


    } else {
        $('form.username-creation').on('submit', function () {
        ...
        function createChat(username, usercolor) {
